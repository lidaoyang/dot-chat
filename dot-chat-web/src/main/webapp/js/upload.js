...
function uploadImageFile(file, model, successFn) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            let msgFileO = new MsgFileO(res.data.fileName, res.data.newFileName, res.data.fileSize, res.data.extName, res.data.url, 1);
            successFn(msgFileO);
        },
        error: function (err) {
            console.error(err);
...
function uploadImageFileAsync(file, model, successFn) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            let msgFileO = new MsgFileO(res.data.fileName, res.data.newFileName, res.data.fileSize, res.data.extName, res.data.url, 0);
            successFn(msgFileO);
        },
        error: function (err) {
            console.error(err);
...
function uploadVideoAsync(file, model, successFn) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.code !== 200) {
                logger.info("上传视频失败,res:", res);
                myAlert('', res.message, "err");
                return;
            }
            let msgFileO = new MsgFileO(res.data.fileName, res.data.newFileName, res.data.fileSize, res.data.extName, res.data.url, 0, res.data.coverUrl);
            successFn(msgFileO);
        },
        error: function (err) {
            console.error(err);
