...
public final class RegularConstants {
    ...
    //url http/https开头
    public static final String URL = "(https://|http://)?([\\w-]+\\.)+[\\w-]+(:\\d+)*(/[\\w- ./?%&=]*)?";
    ...
    // 校验 "yyyy-MM-dd" 日期格式的正则表达式 如2024-01-09
    ...
    public static final String LONGITUDE = "(((?:[0-9]|[1-9][0-9]|1[0-7][0-9])\\.([0-9]{0,6}))|((?:180)\\.([0]{0,6}))|((?:[0-9]|[1-9][0-9]|1[0-7][0-9]))|(?:180))";


    public static final String LATITUDE = "(((?:[0-9]|[1-8][0-9]|90)\\.([0-9]{0,6}))|(?:[0-9]|[1-8][0-9]|90))";
