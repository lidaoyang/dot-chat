...
import com.jr.comm.constants.TokenConstant;
...
public class RequestUtil extends HttpServlet {
    ...
    public static String getHeader(String headerKey) {
        ...
        if (request == null) {
            ...
            throw new ApiException(ExceptionCodeEm.UNAUTHORIZED);
        }
    ...
    public static String getTokenFormRequest() {
    ...
    public static String getTokenFormRequest(HttpServletRequest request) {
        ...
        return request.getParameter(TokenConstant.HEADER_AUTHORIZATION_KEY);
    }
